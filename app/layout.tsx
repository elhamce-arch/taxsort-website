...
export const metadata: Metadata = {
  ...
  keywords: ["tax app for freelancers", "receipt scanner", "mileage tracker", "expense tracker", "self-employed tax", "freelancer taxes", "gig worker taxes", "self-employed Canada", "self-employed USA", "self-employed UK", "self-employed Australia", "CRA tax categories", "IRS tax categories", "HMRC SA103F", "ATO myTax", "freelancer tax deductions"],
  alternates: { canonical: "https://www.taxsort.app" },
  openGraph: {
    type: "website",
    siteName: "TaxSort",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <link rel="alternate" hrefLang="en-us" href="https://www.taxsort.app" />
        <link rel="alternate" hrefLang="en-ca" href="https://www.taxsort.app" />
